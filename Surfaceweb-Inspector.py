# To use the script, you will need to have Python 3 and the required libraries (Tkinter, requests, and BeautifulSoup) installed on your computer. You can then run the script by entering the following command in a terminal or command prompt: python3 Surfaceweb-Inspector.py
